...
{	
	...
	protected:
		...
		double perpendicularDistance(const Eigen::Vector3d aimpoint,const Eigen::Vector3d point1,const Eigen::Vector3d point2) const;
	...
	public:
		...
		std::vector<Eigen::Vector3d> pathSimplify(const std::vector<Eigen::Vector3d> &path, const double path_resolution,int ind1,int ind2);
